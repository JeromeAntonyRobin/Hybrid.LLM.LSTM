...
# STILL IN PROGRESS
The progression of the project is temporarily slowed down due to Hardware limitations as running a LLM and a LSTM on the same hardware is very resourse hungry
